...
public class MainActivity2 extends AppCompatActivity {
    ...
    private EditText imgDescription,AboutImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity2.this, ViewImageActivity.class);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Upload upload = new Upload(imgDescription.getText().toString().trim(), uri.toString(),AboutImage.getText().toString().trim());
